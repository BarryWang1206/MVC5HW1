namespace MVC5HW1.Models
{
	public static class RepositoryHelper
	{
		...
		public static viwCusStatisticsRepository GetviwCusStatisticsRepository()
		{
			var repository = new viwCusStatisticsRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static viwCusStatisticsRepository GetviwCusStatisticsRepository(IUnitOfWork unitOfWork)
		{
			var repository = new viwCusStatisticsRepository();
			repository.UnitOfWork = unitOfWork;
			return repository;
